    ...
    <section className="flex flex-col justify-center items-center px-[60px] py-[60px] w-full h-[924px] bg-[#E8E8E8]">
      <div className="flex flex-col justify-center items-center gap-8 w-[660px]">
        <div className="flex flex-col justify-center items-center gap-4 w-full">
          <h1 className="font-roboto font-medium text-[57px] leading-[64px] tracking-[-0.25px] text-center text-black">
            {t('hero.title')}
          </h1>

          <p className="font-roboto font-normal text-[28px] leading-[36px] text-center text-black">
            {t('hero.description')}
          </p>
        </div>
