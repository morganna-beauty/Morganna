...
export default function DiagnosticPage() {
  ...
  const recommendation = useMemo(() => {
    const key =
      selectedCause === 'chemical' && selectedProcess
        ? selectedProcess
        : selectedCause || ''
    ...
    return translated === fullKey
      ? t('diagnostic.recommendations.not_found')
      : translated
          ...
          <motion.div key="step1" {...fadeMotion}>
            <OptionSelector
              ...
              onSelect={(label) => {
                ...
                setSelectedCondition(found?.key || null)
              }}
            />
          </motion.div>
        )}
          ...
          <motion.div key="step2" {...fadeMotion}>
            <OptionSelector
              ...
              onSelect={(label) => {
                ...
                setSelectedCause(found?.key || null)
              }}
            />
          </motion.div>
        )}
          ...
          <motion.div key="step25" {...fadeMotion}>
            <OptionSelector
              ...
              onSelect={(label) => {
                ...
                setSelectedProcess(found?.key || null)
              }}
            />
          </motion.div>
        )}
